...
class _MemoryBoxLoginState extends State<MemoryBoxLogin> {
                ...
                child: Column(
                  ...
                  children: [
                    const Text('MemoryBox',
                        style: TextStyle(
                          color: Color(0xffa44a62), fontSize: 35, height: 1.05,
                          fontWeight: FontWeight.w700, fontStyle: FontStyle.italic,
                          fontFamily: 'serif')),
                    const SizedBox(height: 25),
                    const Text('Bem-vindo ao seu',
                        style: TextStyle(
                          color: Color(0xff2d2a24), fontSize: 32, height: 1.12,
                          fontWeight: FontWeight.w400, fontFamily: 'serif')),
                    const Text('baú de memórias',
                        style: TextStyle(
                          color: Color(0xffa44a62), fontSize: 31, height: 1.2,
                    ...
                    const Text(
                      ...
                      style: TextStyle(
                        color: Color(0xff56514a), fontSize: 18,
                      ...
                      child: Column(
                        ...
                        children: [
                          const Padding(
                            ...
                            child: Text('E-MAIL',
                                style: TextStyle(
                                  color: Color(0xff5f5a50), fontSize: 16,
                                ...
                                if (_modoLogin)
                                  GestureDetector(
                                    ...
                                    child: const Text('Esqueceu?',
                                        style: TextStyle(
                                          color: Color(0xffa44a62), fontSize: 14,
                          ...
                          Center(
                            child: GestureDetector(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  style: const TextStyle(
                                      color: Color(0xff4d493f), fontSize: 15),
                                  children: [
                                    TextSpan(
                                        text: _modoLogin
                                            ? 'Não tem uma conta? '
                                    ...
                                    TextSpan(
                                        text: _modoLogin
                                            ...
                                            : 'Fazer login',
                                        style: const TextStyle(
                                          color: Color(0xffa44a62), fontSize: 15,
                                          fontWeight: FontWeight.w500)),
                                  ])))),
                          const SizedBox(height: 31),
                          Row(children: [
                            ...
                            const Padding(
                              ...
                              child: Text('OU',
                                  style: TextStyle(
                                    color: Color(0xff6a655a), fontSize: 15,
                                    fontWeight: FontWeight.w700))),
                            _linha(),
                          ]),
                          ...
                          const Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                color: Color(0xffa44a62), fontSize: 11),
    ...
    required TextInputType tipo,
      ...
      TextField(
        ...
        decoration: InputDecoration(
          ...
          hintText: hint,
          hintStyle: const TextStyle(color: Color(0xffaaa495), fontSize: 17),
          prefixIcon: Icon(icon, color: const Color(0xff7b7468), size: 25),
  ...
  Widget _linha() =>
      Expanded(child: Container(height: 1, color: const Color(0xffe7e1c8)));
...
class _MemoryBoxPerfilState extends State<MemoryBoxPerfil> {
              ...
              child: Padding(
                ...
                child: Column(children: [
                  const Text('MemoryBox',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Color(0xffa44a62), fontSize: 28,
                        fontWeight: FontWeight.w700,
                  ...
                  InkWell(
                    ...
                    child: const Padding(
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Text('Sair',
                            style: TextStyle(
                              color: Color(0xff56514a), fontSize: 16,
                  ...
                  const Padding(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Color(0xff8b887d), fontSize: 10, height: 1.25))),
                ])))))));
  }
            ...
            child: user?.photoURL != null
                ? Image.network(user!.photoURL!, fit: BoxFit.cover,
                    errorBuilder: (_, __, ___) => const Icon(
                        Icons.person_outline, color: Color(0xff565d47), size: 74))
  ...
  Widget _tituloCampo(String t) => Text(t,
      style: const TextStyle(
        color: Color(0xff5f5a50), fontSize: 13,
  ...
  Widget _campo(TextEditingController ctrl, IconData icon, TextInputType tipo,
      ...
      TextField(
        ...
        decoration: InputDecoration(
          filled: true,
          fillColor: readOnly ? const Color(0xffe4deca) : const Color(0xffede8d3),
          suffixIcon: Icon(icon, color: const Color(0xff7b7468), size: 24),
          border: OutlineInputBorder(
  ...
  Widget _tituloSecao(String t) => Align(
        ...
        child: Padding(
          ...
          child: Text(t,
              style: const TextStyle(
                color: Color(0xff56514a), fontSize: 13,
          ...
          child: Row(children: [
            Container(
              ...
              decoration: const BoxDecoration(
                  color: Color(0xfffbf8df), shape: BoxShape.circle),
              child: Icon(icon, color: AppTheme.primary, size: 25)),
            const SizedBox(width: 20),
            Expanded(
                child: Text(txt,
                    style: const TextStyle(
                      color: Color(0xff3f3b34), fontSize: 17,
                      fontWeight: FontWeight.w500))),
  ...
  Widget _botaoExcluir() => InkWell(
        ...
        child: Container(
          ...
          child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.delete_forever_outlined, color: Color(0xffb84035)),
            SizedBox(width: 9),
            Text('Excluir Conta',
                style: TextStyle(
                  color: Color(0xffb84035), fontSize: 16,
                  fontWeight: FontWeight.w700)),
          ])));
}
