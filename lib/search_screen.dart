...
class _SearchScreenState extends State<SearchScreen> {
        ...
        ...cats.map((c) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: sel ? c.color : c.color.withOpacity(0.35),
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
  ...
  Widget _buildEmptyState() => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Container(
        width: 72, height: 72,
        decoration:
            BoxDecoration(color: AppTheme.primary.withOpacity(0.08), shape: BoxShape.circle),
        child: const Icon(Icons.search, size: 32, color: AppTheme.primary)),
      const SizedBox(height: 16),
      const Text('Busque suas memórias',
          style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600,
              color: AppTheme.textDark)),
      const SizedBox(height: 8),
      const Text('Digite um título, descrição\nou selecione uma categoria',
  ...
  Widget _buildNoResults() => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Text('Nenhuma memória encontrada\npara "$_query"',
          textAlign: TextAlign.center,
    ...
    return Container(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          ...
          height: 48,
          decoration:
              BoxDecoration(color: AppTheme.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(10)),
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            if (memory.categories.isNotEmpty) ...[
              ...
              Wrap(spacing: 6, children: memory.categories.map((c) =>
                Container(
                  ...
                  decoration:
                      BoxDecoration(color: c.color.withOpacity(0.4), borderRadius: BorderRadius.circular(10)),
                  child: Text(c.name,
                      style: const TextStyle(
