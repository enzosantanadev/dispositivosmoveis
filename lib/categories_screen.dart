...
class _CategoriesScreenState extends State<CategoriesScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_selectedCategoryId == null)
                Expanded(child: _buildAllMemories(state)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildAllMemories(AppState state) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, i) {
        final m = memories[i];
        final color = m.categories.isNotEmpty
            ? m.categories.first.color
            : AppTheme.primary.withOpacity(0.3);
        return _MemoryCard(memory: m, accentColor: color);
      },
    );
  }
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (_) =>
                        CreateTagScreen(editCategory: cat),
                  ),
                );
              },
            ),
